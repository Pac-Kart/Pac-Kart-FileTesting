...
function get_hwvx_proto_triggers_and_actions_4trest(o, a) {
    ...
    o = _1st_length
    for (let i = 0; i < _2nd_amnt; i++) {// ö(u32(o + 4 + (i * 4)), get_hwvx_proto_triggers_and_actions_4trest_2nd)
...
function get_hwvx_proto_triggers_and_actions_20(o) {
    ...
    case 12:
        ...
        break
    case 15:
        ö(u32(o + 4), get_hwvx_proto_triggers_and_actions_20_4t15)
        //5,1 | u32 | 8 | 7827760
        break
    case 17:
...
function get_hwvx_proto_geo_list_4_16(o) {// ü(1, [u8, 0], o)
