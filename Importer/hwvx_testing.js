...
function get_hwvx_directory(o, end_offset) {
    ...
    globalThis.hwvx_interface_text_related = []
    globalThis.hwvx_unknown_thing = []
    globalThis.hwvx_sound_controls = []
    globalThis.hwvx_sound_section = []
    globalThis.hwvx_unknown = []
    globalThis.hwvx_car_related = []
    globalThis.hwvx_strange = []
    globalThis.hwvx_model = []
    globalThis.hwvx_model_anims_1 = []
    globalThis.hwvx_model_anims_2 = []
    globalThis.hwvx_asdf = []
    globalThis.hwvx_unknown_idk_sec = []
    globalThis.hwvx_grand_section = []
    globalThis.hwvx_world_color_section = []
    globalThis.hwvx_world_small_section = []
    globalThis.hwvx_world_36_36 = []
    globalThis.hwvx_world_36_48 = []
    globalThis.hwvx_world_model_related = []
    globalThis.hwvx_collision_link = []
    globalThis.hwvx_collision_related = []
    globalThis.hwvx_world_12 = []
    globalThis.hwvx_world_idk = []
    globalThis.hwvx_some_world_thing = []
    globalThis.hwvx_world_108_44t6 = []
    globalThis.hwvx_world_routes = []
    ...
    globalThis.hwvx_car_link = []
    globalThis.hwvx_car_unknown_link = []
    globalThis.hwvx_unknown_link_section = []
    globalThis.hwvx_world_76 = []
    globalThis.hwvx_world_20 = []
    globalThis.hwvx_interface_unknown = []
    globalThis.hwvx_car_path_related = []
    globalThis.hwvx_unknown_whatever = []
    globalThis.hwvx_unknown_small_model_link = []
...
function get_hwvx_datapack(o) {
    ...
    if (u32(o + 68)) {
        for (let i = 0; i < u32(o + 64); i++) {
            get_hwvx_triggers_and_actions(offset_mid + u32(o + 68) + (i * 44))
        }
    }
...
function get_hwvx_triggers_and_actions(o) {
    ...
    switch (u32(o + 8)) {
    case 1:
        ö(u32(o + 4), get_hwvx_triggers_and_actions_4t1)
        break
    case 3:
        ö(u32(o + 4), get_hwvx_triggers_and_actions_4t3)
        break
    case 5:
        ö(u32(o + 4), get_hwvx_triggers_and_actions_4t5)
        break
    case 6:
        ö(u32(o + 4), get_hwvx_triggers_and_actions_4t6)
        break
    default:
        ß('p_offset', u32(o + 4), offset_mid)
        get_hwvx_triggers_and_actions_4trest(u32(o + 4) + offset_mid, u32(o + 8))
    }
    if (u32(o + 4)) {// ü(0, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u8, 40,u8, 41,u8, 42,u8, 43,], o)
    // get_hwvx_triggers_and_actions_4test(u32(o + 4) + offset_mid)
    }

    for (let i = 0; i < u32(o + 16); i++) {
        ö(u32(o + 12) + (i * 44), get_hwvx_triggers_and_actions_12)
    }
    for (let i = 0; i < u32(o + 28); i++) {
        ö(u32(o + 20) + (i * 24), get_hwvx_actions)
    }

}
function get_hwvx_triggers_and_actions_4t1(o) {
...
function get_hwvx_triggers_and_actions_4t2(o) {
    // if (u32(o + 0) !== 1 || u32(o + 8) || u32(o + 12))
    //     ü(3, [u32, 0], o)
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    // ä(hwvx_triggers_and_actions_4t2_4, u32(o + 4), get_hwvx_triggers_and_actions_4t2_4)

}

function get_hwvx_triggers_and_actions_4t2_4(o) {// ü(3, [u32, 0], o) //ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
//some 64 byte strucute in world
}

function get_hwvx_triggers_and_actions_4t3(o) {
    if (u32(o + 0) !== 1 || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ö(u32(o + 4), get_hwvx_triggers_and_actions_4t3_4)
    // ä(hwvx_triggers_and_actions_4t3_4, u32(o + 4), get_hwvx_triggers_and_actions_4t3_4)

}

function get_hwvx_triggers_and_actions_4t3_4(o) {
    let check_val = o
    ...
    //duplicate found: get_hwvx_triggers_and_actions_4t3_4 -> get_hwvx_Airbox

}

function get_hwvx_triggers_and_actions_4t5(o) {
    if (u32(o + 0) !== 1 || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, f32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)

    ö(u32(o + 4), get_hwvx_triggers_and_actions_4t5_4)

    switch (u32(o + 16)) {
    case 0:
        ö(u32(o + 12), get_hwvx_triggers_and_actions_4t5_12t0)
        break
    case 21:
    case 22:
        break
...
function get_hwvx_triggers_and_actions_4t5_4(o) {
    let check_val = o
...
function get_hwvx_triggers_and_actions_4t5_12t0(o) {
    let check_val = o
...
function get_hwvx_triggers_and_actions_4t6(o) {
    ...
    case 2:
        //trest
        ß('p_offset', u32(o + 4), offset_mid)
        get_hwvx_triggers_and_actions_4trest(o, 6)
        break
    case 4:
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
...
function get_hwvx_triggers_and_actions_4trest(o, a) {
    let end_length = (a * 4) + o
    let _1st_amnt = u32(o)
    let _1st_length = (_1st_amnt * 4) + 4 + o

    for (let i = 0; i < _1st_amnt; i++) {
        get_hwvx_triggers_and_actions_4trest_1st(u32(o + 4) + (i * 4))
        ö(u32(o + 4 + (i * 4)), get_hwvx_triggers_and_actions_4trest_1st)
    }
    ...
    for (let i = 0; i < _2nd_amnt; i++) {
        ö(u32(o + 4 + (i * 4)), get_hwvx_triggers_and_actions_4trest_2nd)
        // ä(hwvx_triggers_and_actions_4trest_2nd, u32(o + 4) + (i*4), get_hwvx_triggers_and_actions_4trest_2nd)
    }

    // console.log(`a:${o} e: ${end_length} | _1st_amnt: ${_1st_amnt} / ${_1st_length}  _2nd_amnt: ${_2nd_amnt} / ${_2nd_length}`)
}

function get_hwvx_triggers_and_actions_4trest_1st(o) {
    let check_val = o
    ...
    // console.log(o,offset_mid)
    // ä(hwvx_triggers_and_actions_4trest_1st, o - offset_mid, get_hwvx_triggers_and_actions_4trest_2nd)

}
function get_hwvx_triggers_and_actions_4trest_2nd(o) {
    let check_val = o
    if (hwvx_world_12.includes(check_val)) {
        return
    }
...
function get_hwvx_triggers_and_actions_4test(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}

function get_hwvx_triggers_and_actions_12(o) {
    ...
    ö(u32(o + 4), get_hwvx_triggers_and_actions_12_4)

}

function get_hwvx_triggers_and_actions_12_4(o) {
    // if (u32(o + 0) !== 1 || u32(o + 20) || u32(o + 24) || u32(o + 28))
    if (u32(o) === 1) {
        ö(u32(o + 4), get_hwvx_triggers_and_actions_12_4_4)
...
function get_hwvx_triggers_and_actions_12_4_4(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    //get_hwvx_world_36_48_24 -> get_hwvx_triggers_and_actions_12_4_4
...
function get_hwvx_actions(o) {
    ...
    case 0:
        // //4,5
        ö(u32(o + 4), get_hwvx_actions_4tAirboxChangeMode)
        break
    case 1:
        switch (u32(o + 8)) {
        case 13:
            ö(u32(o + 4), get_hwvx_actions_4tCameraSetTargetst13)
            break
        case 14:
            ö(u32(o + 4), get_hwvx_actions_4t1t14)
            break
        case 17:
            ö(u32(o + 4), get_hwvx_actions_4t1t17)
            break
        default:
            console.log(o)
        }
        break
    case 2:
        ö(u32(o + 4), get_hwvx_actions_4t2)
        //4,5,9,8,7,25,15,10,23,11,6,125,135,192,3,39,96,155,124,85,193,36,67,123,19
        break
    case 3:
        //7,8,9,13,10,11,6,12,16,15,5,27,4,17,14
        ö(u32(o + 4), get_hwvx_actions_4t3)
        break

    case 4:
        ö(u32(o + 4), get_hwvx_actions_4t4)
        break
    case 5:
        //11,30,8,19,12,24,4,10,3,15,22,6,9,18,13,58,25,17,26,37,23,21,5,44
        ö(u32(o + 4), get_hwvx_actions_4t5)
        break
    case 7:
        ö(u32(o + 4), get_hwvx_actions_4t7)
        break
    case 8:
        ö(u32(o + 4), get_hwvx_actions_4t8)
        break
    case 9:
        //5,6

        ö(u32(o + 4), get_hwvx_actions_4t9)
        break
    case 10:
        switch (u32(o + 8)) {
        case 10:
            ö(u32(o + 4), get_hwvx_actions_4t10t10)
            break
        case 20:
            ö(u32(o + 4), get_hwvx_actions_4t10t20)
            break
        default:
            console.log(o)
        }
    ...
    case 12:
        ...
        ö(u32(o + 4), get_hwvx_actions_4t12)
        break
    case 15:
        switch (u32(o + 8)) {
        case 1:
            ö(u32(o + 4), get_hwvx_actions_4t15t1)
            break
        case 5:
            ö(u32(o + 4), get_hwvx_actions_4t15t5)
            break
        }
        break
    case 16:
        //5,6
        ö(u32(o + 4), get_hwvx_actions_4t16)
        break
    case 17:
        //4,5,6,7,11,13,14,16,18,22
        ö(u32(o + 4), get_hwvx_actions_4t17)
        break
    case 20:
        ö(u32(o + 4), get_hwvx_actions_4t20)
        break
    case 21:
        ö(u32(o + 4), get_hwvx_actions_4t21)
        break
    case 22:
        //11,5,8,6,9,20,18,16,7,23,25,10,13,19,15
        ö(u32(o + 4), get_hwvx_actions_4t22)
        break
    case 24:
        ö(u32(o + 4), get_hwvx_actions_4t24)
        break
    case 26:
        ö(u32(o + 4), get_hwvx_actions_4t26)
        break
    case 31:
        ö(u32(o + 4), get_hwvx_actions_4t31)
        break
    case 32:
        ö(u32(o + 4), get_hwvx_actions_4t32)
        break
    case 34:
        switch (u32(o + 8)) {
        case 5:
            ö(u32(o + 4), get_hwvx_actions_4t34t5)
            break
        case 6:
            ö(u32(o + 4), get_hwvx_actions_4t34t6)
            break
        }
        break
    case 36:
        ö(u32(o + 4), get_hwvx_actions_4t36)
        break
    case 38:
        ö(u32(o + 4), get_hwvx_actions_4t38)
        break
    case 39:
        ö(u32(o + 4), get_hwvx_actions_4t39)
        break
    case 40:
        ö(u32(o + 4), get_hwvx_actions_4t40)
        break
    case 41:
        ö(u32(o + 4), get_hwvx_actions_4t41)
        break
    }
}

function get_hwvx_actions_4tAirboxChangeMode(o) {
    let amt = u32(o + 4)
...
function get_hwvx_actions_4tCameraSetTargetst13(o) {
    ...
    case 1:
        ...
        break
    case 6:
        ä(hwvx_world_routes, u32(o + 12), get_hwvx_world_routes)
        break
    }
    switch (u32(o + 28)) {
    case 1:
...
function get_hwvx_actions_4t1t14(o) {
    ...
    case 3:
        ...
        break
    case 6:
        ä(hwvx_world_routes, u32(o + 16), get_hwvx_world_routes)
        break
    default:
        console.log(o)
    }
    ...
    case 4:
        ...
        break
    case 6:
        ä(hwvx_world_routes, u32(o + 36), get_hwvx_world_routes)
        break
    }

}

function get_hwvx_actions_4t1t17(o) {
    ...
    case 3:
        ...
        break
    case 6:
        ä(hwvx_world_routes, u32(o + 28), get_hwvx_world_routes)
        break
    default:
        console.log(o)
    }
    ...
    case 3:
        ...
        break
    case 6:
        ä(hwvx_world_routes, u32(o + 48), get_hwvx_world_routes)
        break
    default:
        console.log(o)
    }
...
function get_hwvx_actions_4t12(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o) 
    //ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    let amt = u32(o + 4)

    for (let i = 0; i < amt; i++) {
        ä(hwvx_world_routes, u32(o + 8 + (i * 4)), get_hwvx_world_routes)
    }
}
function get_hwvx_actions_4t16(o) {
...
function get_hwvx_actions_4t17(o) {
    //ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    let amt = u32(o + 4)
...
function get_hwvx_actions_4t2(o) {
    // ü(3, [u32, 0], o)
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    let amt = u32(o + 4)
...
function get_hwvx_actions_4t4(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        // ü(3, [u32, 0], o)
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ä(hwvx_interface, u32(o + 0), get_hwvx_interface)
...
function get_hwvx_actions_4t7(o) {
...
function get_hwvx_actions_4t8(o) {
    if (u32(o + 8) !== 1)
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ä(hwvx_world_76, u32(o + 12), get_hwvx_world_76)
...
function get_hwvx_actions_4t9(o) {
...
function get_hwvx_actions_4t10t10(o) {
...
function get_hwvx_actions_4t10t20(o) {
...
function get_hwvx_actions_4t15t1(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_actions_4t15t5(o) {
    ...
    case 4:
        ...
        break
    case 6:
        ä(hwvx_world_routes, u32(o + 4), get_hwvx_world_routes)
        break
    default:
        console.log(o)
    }
...
function get_hwvx_actions_4t20(o) {
...
function get_hwvx_actions_4t21(o) {
...
function get_hwvx_actions_4t22(o) {
    // ü(3, [u32, 0], o) 
    // ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    let amt = u32(o + 8)
    for (let i = 0; i < amt; i++) {
...
function get_hwvx_actions_4t24(o) {
...
function get_hwvx_actions_4t26(o) {
    if (u32(o + 4) !== 1 || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ä(hwvx_world_76, u32(o + 8), get_hwvx_world_76)
...
function get_hwvx_actions_4t31(o) {
    if (u32(o + 0) !== 1 || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
...
function get_hwvx_actions_4t32(o) {
    if (u32(o + 0) !== 1 || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_actions_4t34t5(o) {
    if (u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, f32, 16, f32, 20, u32, 24, u32, 28, ], o)
    //ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, f32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
function get_hwvx_actions_4t34t6(o) {
...
function get_hwvx_actions_4t34(o) {
    // if (u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
    //     if (u32(o + 4) === 1) {
...
function get_hwvx_actions_4t36(o) {
    if (u32(o + 0) !== 7 || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_actions_4t38(o) {
    if (u32(o + 0) !== 1 || u32(o + 4) !== 1 || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_actions_4t39(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_actions_4t40(o) {
...
function get_hwvx_actions_4t41(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
...
function get_hwvx_actions_4t3(o) {
...
function get_hwvx_actions_4t5(o) {
    //ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    let amt = u32(o + 4)
...
function get_hwvx_world(o) {
    ...
    ö(u32(o + 124), get_hwvx_world_124)
    ö(u32(o + 132), get_hwvx_world_132)
    ö(u32(o + 140), get_hwvx_world_140)
    // // WORLDS_\*
    // // WORLDS_\*
    // // WORLDS_\*

    ö(u32(o + 156), get_hwvx_world_settings)

}
function get_hwvx_world_124(o) {
...
function get_hwvx_world_132(o) {
    // ü(1, [f32, 0, f32, 4, f32, 8, u8, 12, u8, 13, u8, 14, u8, 15, u32, 16, u32, 20, u32, 24, u32, 28, f32, 32, f32, 36, f32, 40, u32, 44, u32, 48, u32, 52, u32, 56, u32, 60, ], o)
}
function get_hwvx_world_140(o) {
    // ü(1, [f32, 0, f32, 4, f32, 8, u8, 12, u8, 13, u8, 14, u8, 15, u32, 16, u32, 20, u32, 24, u32, 28, f32, 32, f32, 36, f32, 40, u32, 44, u32, 48, u32, 52, u32, 56, u32, 60, ], o)
}
...
function get_hwvx_world_4_20(o) {
    // ü(1, [u32, 0], o)
}
...
function get_hwvx_world_12(o) {
    ...
    ä(hwvx_world_idk, u32(o + 64), get_hwvx_world_idk)
    ä(hwvx_world_idk, u32(o + 68), get_hwvx_world_idk)
    ä(hwvx_world_idk, u32(o + 72), get_hwvx_world_idk)
    ä(hwvx_world_idk, u32(o + 76), get_hwvx_world_idk)
...
function get_hwvx_world_20(o) {
    ...
    ö(u32(o + 12), get_hwvx_model_car_sound_link)

}
function get_hwvx_model_car_sound_link(o) {
    ...
    ß('p_model', o, 0)
    ä(hwvx_car_link, u32(o + 16), get_hwvx_car_link)
    ö(u32(o + 28), get_hwvx_model_car_sound_link_28)

}
function get_hwvx_model_car_sound_link_28(o) {
...
function get_hwvx_Airbox(o) {
    ...
    ä(hwvx_world_model_related, u32(o + 36), get_hwvx_world_model_related)

}

function get_hwvx_world_model_related(o) {
    ü(1, [u32, 0, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
    ...
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 32), get_hwvx_mysterious)
    }
...
function get_hwvx_world_36_48_16(o) {
    ...
    ä(hwvx_strange, u32(o + 36), get_hwvx_strange)
...
function get_hwvx_world_76(o) {
    // ü(1, [u32, 0], o)
    ä(hwvx_world_small_section, u32(o + 0), get_hwvx_world_small_section)
...
function get_hwvx_world_92(o) {
    if (u32(o + 0))
        ü(1, [u32, 0, u32, 4], o)
    ö(u32(o + 4), get_hwvx_world_text_link)

}

function get_hwvx_world_text_link(o) {
    if (u8(o + 1) !== 23 || u8(o + 3) || u32(o + 4) || u32(o + 28))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
    ä(hwvx_world_small_section, u32(o + 12), get_hwvx_world_small_section)
    ä(hwvx_world_small_section, u32(o + 16), get_hwvx_world_small_section)
...
function get_hwvx_world_100(o) {
    ...
    ä(hwvx_world_color_section, u32(o + 4), get_hwvx_world_color_section)

}

function get_hwvx_world_color_section(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o + 0); i++) {
        ö(u32(o + 4) + (i * 12), get_hwvx_world_color_section_4)
    }

}

function get_hwvx_world_color_section_4(o) {
...
function get_hwvx_world_120(o) {
    ...
    for (let i = 0; i < u32(o + 4); i++) {
        ä(hwvx_world_routes, u32(o + 0) + (i * 96), get_hwvx_world_routes)
    }

}

function get_hwvx_world_routes(o) {
    ...
    for (let i = 0; i < u32(o + 16); i++) {
        ö(u32(o + 20) + (i * 4), get_hwvx_world_routes_20)
        ö(u32(o + 24) + (i * 4), get_hwvx_world_routes_24)
    }
    for (let i = 0; i < u32(o + 28); i++) {
        ö(u32(o + 32) + (i * 4), get_hwvx_world_routes_32)
    }

}

function get_hwvx_world_routes_20(o) {
    // ü(1, [f32, 0], o)
}
function get_hwvx_world_routes_24(o) {
    // ü(1, [u32, 0], o)
}
function get_hwvx_world_routes_32(o) {
    // ü(1, [u32, 0], o)
}

function get_hwvx_world_settings(o) {
    ...
    // // HW_Items
    ö(u32(o + 192), get_hwvx_world_settings_192)
    ö(u32(o + 196), get_hwvx_world_settings_196)
    ä(hwvx_font, u32(o + 200), get_hwvx_font)

    ä(hwvx_interface, u32(o + 204), get_hwvx_interface)
    ö(u32(o + 224), get_hwvx_world_settings_224)
    ö(u32(o + 228), get_hwvx_world_settings_228)
    for (let i = 0; i < u32(o + 232); i++) {
        ö(u32(o + 236) + (i * 4), get_hwvx_world_settings_236)
    }
    for (let i = 0; i < u32(o + 240); i++) {
        ö(u32(o + 244) + (i * 4), get_hwvx_world_settings_244)
    }
    for (let i = 0; i < u32(o + 248); i++) {
        ö(u32(o + 252) + (i * 4), get_hwvx_world_settings_244)
    }
    for (let i = 0; i < u32(o + 256); i++) {
        ö(u32(o + 260) + (i * 12), get_hwvx_world_settings_260)
    }
    if (old_log_array.p_offset.array.includes(o + 156 - offset_mid)) {
        ß('p_offset', u32(o + 156), offset_mid)
        ö(u32(o + 156), get_hwvx_world_settings_156)
    }

    ö(u32(o + 272), get_hwvx_world_settings_272)

}

function get_hwvx_world_settings_156(o) {
    let check_val = o
    if (hwvx_car_link.includes(check_val)) {
        return
    }
    if (hwvx_world_36_36.includes(check_val)) {
        return
...
function get_hwvx_world_settings_272(o) {
    if (u32(o + 0) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    ö(u32(o + 4), get_hwvx_world_settings_272_4)

}

function get_hwvx_world_settings_272_4(o) {
...
function get_hwvx_world_settings_192(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_world_settings_196(o) {
    ...
    ö(u32(o + 28), get_hwvx_world_settings_196_28)
    ä(hwvx_sound_controls, u32(o + 32), get_hwvx_sound_controls)

}

function get_hwvx_world_settings_196_28(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
...
function get_hwvx_world_settings_224(o) {
...
function get_hwvx_world_settings_228(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_world_settings_236(o) {
    // ü(3, [u32, 0], o) 
    // ü(1, [u32, 0], o)
    ö(u32(o + 0), get_hwvx_world_settings_236_0)

}
function get_hwvx_world_settings_236_0(o) {
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, ], o)
    ö(u32(o + 28), get_hwvx_world_settings_236_0_28)

}

function get_hwvx_world_settings_236_0_28(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)
}

function get_hwvx_world_settings_244(o) {
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)

}
function get_hwvx_world_settings_260(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8], o)
    ö(u32(o + 4), get_hwvx_world_settings_260_4)

}

function get_hwvx_world_settings_260_4(o) {
...
function get_hwvx_collision(o) {
    ...
    ä(hwvx_collision_link, u32(o + 92), get_hwvx_collision_link)
...
function get_hwvx_collision_32(o) {
    ...
    if (u32(o + 48)) {
        for (let i = 0; i < u32(o + 60); i++) {
            ä(hwvx_collision_related, u32(o + 48) + (i * 32), get_hwvx_collision_related)
        }
    }
    ...
    // ö(u32(o + 68), get_hwvx_collision_related8)
    // console.log(u32(o+64))
    ä(hwvx_collision_related, u32(o + 68), get_hwvx_collision_related)

}

function get_hwvx_collision_related8(o) {// ü(3, [u32, 0], o) 
// ü(1, [f32, 0, f32, 4, f32, 8, f32, 12, u8, 16, u8, 17, u8, 18, u8, 19, u8, 20, u8, 21, u8, 22, u8, 23, u8, 24, u8, 25, u8, 26, u8, 27, u8, 28, u8, 29, u8, 30, u8, 31], o)
}
...
function get_hwvx_collision_related(o) {
// ü(1, [u32, 0], o)
}
...
function get_hwvx_collision_link(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)

    ö(u32(o + 0), get_hwvx_collision_settings)
    ö(u32(o + 4), get_hwvx_collision_settings)
}

function get_hwvx_collision_settings(o) {
    ...
    ä(hwvx_unknown_thing, u32(o + 52), get_hwvx_unknown_thing)
    ä(hwvx_sound_section, u32(o + 60), get_hwvx_sound_section)
    ä(hwvx_unknown, u32(o + 64), get_hwvx_unknown)
    for (let i = 0; i < u32(o + 68); i++) {
        ö(u32(o + 72) + (i * 4), get_hwvx_collision_settings_72)
    }
    for (let i = 0; i < u32(o + 76); i++) {
        ö(u32(o + 80) + (i * 4), get_hwvx_collision_settings_72)
    }

}

function get_hwvx_collision_settings_72(o) {
    // ü(1, [u32, 0], o)
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)
...
function get_hwvx_car(o) {
    ...
    ä(hwvx_car_related, u32(o + 144), get_hwvx_car_related)
    ä(hwvx_car_related, u32(o + 148), get_hwvx_car_related)
    ä(hwvx_car_related, u32(o + 152), get_hwvx_car_related)
    ä(hwvx_car_related, u32(o + 156), get_hwvx_car_related)
    ä(hwvx_car_link, u32(o + 160), get_hwvx_car_link)
...
function get_hwvx_car_120(o) {
    ...
    ö(u32(o + 16), get_hwvx_model_link)

}

function get_hwvx_model_link(o) {
    ...
    ö(u32(o + 4), get_hwvx_model_link_4)
    for (let i = 0; i < u32(o + 8); i++) {
        ö(u32(o + 12) + (i * 8), get_hwvx_model_link_12)
    }
    ä(hwvx_model_anims_1, u32(o + 16), get_hwvx_model_anims_1)
    ä(hwvx_model_anims_2, u32(o + 20), get_hwvx_model_anims_2)
    ö(u32(o + 32), get_hwvx_model_link_32)
    ö(u32(o + 36), get_hwvx_model_link_36)
    ö(u32(o + 48), get_hwvx_model_link_48)
    ö(u32(o + 52), get_hwvx_model_link_52)
    ö(u32(o + 56), get_hwvx_model_link_56)

}

function get_hwvx_model_link_4(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    ß('p_model', o, 0)
}
function get_hwvx_model_link_12(o) {
    // ü(1, [u32, 0, u32, 4], o)
    ß('p_model', o, 0)
}
function get_hwvx_model_link_32(o) {
    if (u32(o + 0) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, f32, 4, u32, 8, u32, 12], o)
}
function get_hwvx_model_link_36(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, f32, 4, u32, 8, u32, 12], o)
}

function get_hwvx_model_link_48(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12) || u8(o + 16) !== 1 || u8(o + 17) || u8(o + 18) || u8(o + 19) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, u32, 20, u32, 24, u32, 28, ], o)
}

function get_hwvx_model_link_52(o) {
...
function get_hwvx_model_link_56(o) {
    if (u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)

    for (let i = 0; i < u32(o + 0); i++) {
        ö(u32(o + 4) + (i * 28), get_hwvx_model_link_56_4)
    }
    ä(hwvx_model_anims_2, u32(o + 8), get_hwvx_model_anims_2)

}

function get_hwvx_model_link_56_4(o) {
    if (u8(o + 1) !== 1 || u8(o + 2) !== 1 || u8(o + 3) || u32(o + 20) || u32(o + 24))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24], o)
    ß('p_model', o, 8)

    ö(u32(o + 12), get_hwvx_model_link_56_4_12)
    ö(u32(o + 16), get_hwvx_model_link_56_4_16)

}

function get_hwvx_model_link_56_4_12(o) {
    if (u32(o + 12))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12], o)
}
function get_hwvx_model_link_56_4_16(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
}
...
function get_hwvx_car_related(o) {
    ...
    for (let i = 0; i < u32(o + 44); i++) {
        ö(u32(o + 48) + (i * 12), get_hwvx_car_related_48)
    }

}

function get_hwvx_car_related_48(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8], o)
    ä(hwvx_car_path_related, u32(o + 0), get_hwvx_car_path_related)
    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 12), get_hwvx_car_related_48_8)
    }

}

function get_hwvx_car_path_related(o) {
    ...
    ö(u32(o + 88), get_hwvx_car_path_related_88)

    // ö(u32(o + 116), get_hwvx_string)
    ö(u32(o + 116), get_hwvx_car_related_116)

}
function get_hwvx_car_path_related_88(o) {
...
function get_hwvx_car_related_116(o) {
console.log(get_string(o, 0, false))
}

function get_hwvx_car_related_48_8(o) {
    if (u32(o + 4) || u32(o + 8))
        ü(1, [u32, 0, u32, 4, u32, 8], o)
    ä(hwvx_car_path_related, u32(o + 0), get_hwvx_car_path_related)
...
function get_hwvx_car_link(o) {
    ...
    ä(hwvx_car_unknown_link, u32(o + 48), get_hwvx_car_unknown_link)

    for (let i = 0; i < u32(o + 52); i++) {
        ö(u32(o + 56) + (i * 4), get_hwvx_car_link_56)
    }
    ö(u32(o + 64), get_hwvx_car_link_64)
    ö(u32(o + 68), get_hwvx_car_link_68)

}

function get_hwvx_car_unknown_link(o) {
    ...
    for (let i = 0; i < u32(o + 68); i++) {
        ö(u32(o + 72) + (i * 4), get_hwvx_car_unknown_link_72)
    }
    for (let i = 0; i < u32(o + 76); i++) {
        ö(u32(o + 80) + (i * 4), get_hwvx_car_unknown_link_72)
    }
...
function get_hwvx_car_unknown_link_72(o) {
    // ü(1, [u32, 0], o) 
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)

}

function get_hwvx_car_link_56(o) {
    // ü(1, [u32, 0], o)
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)

}

function get_hwvx_car_link_64(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)
}
function get_hwvx_car_link_68(o) {
...
function get_hwvx_car_228(o) {
    ...
    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 32), get_hwvx_mysterious)
    }

}
function get_hwvx_mysterious(o) {
    if (u32(o + 12) || u32(o + 28))
    ...
    case 1:
        ...
        break
    case 2:
        ä(hwvx_strange, u32(o + 24), get_hwvx_strange)
        break
    case 3:
        ä(hwvx_sound_controls, u32(o + 24), get_hwvx_sound_controls)
        break
    ...
    case 99:
        ...
        break
    case 5:
        ö(u32(o + 24), get_hwvx_mysterious_24t5)
        break
    case 6:
        ö(u32(o + 24), get_hwvx_mysterious_24t6)
        break
    case 7:
        ö(u32(o + 24), get_hwvx_mysterious_24t7)
        break
    case 8:
        ö(u32(o + 0), get_hwvx_model_link)
        break
    case 9:
        ö(u32(o + 24), get_hwvx_mysterious_24t9)
        break
    case 10:
        ö(u32(o + 24), get_hwvx_mysterious_24t10)
        break
    default:
        // ü(3, [u32, 0], o)
...
function get_hwvx_strange(o) {
    ...
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 4), get_hwvx_strange_28)
    }
    ä(hwvx_sound_controls, u32(o + 32), get_hwvx_sound_controls)

}

function get_hwvx_strange_28(o) {
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)

}

function get_hwvx_mysterious_24t5(o) {
if(u32(o+0) ||u32(o+4) ||u32(o+12) ||u32(o+16) ||u32(o+36) ||u32(o+40) )
ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)
    ß('p_model', o, 8)

    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + (i * 32), get_hwvx_mysterious_24t5_24)
    }
    for (let i = 0; i < u32(o + 28); i++) {
        ö(u32(o + 32) + (i * 12), get_hwvx_mysterious_24t5_32)
    }
    ö(u32(o + 44), get_hwvx_mysterious_24t5_44)

}

function get_hwvx_mysterious_24t5_24(o) {
if(u32(o+12) ||u32(o+24) ||u32(o+28) )
ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28], o)
}
function get_hwvx_mysterious_24t5_32(o) {// ü(3, [u32, 0], o) 
/*ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)*/
}
function get_hwvx_mysterious_24t5_44(o) {
if(u32(o+12) ||u32(o+24) ||u32(o+28) )
ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, f32, 16, f32, 20, u32, 24, u32, 28], o)
}

function get_hwvx_mysterious_24t6(o) {
    ...
    ß('p_texture', o, 8)
    for (let i = 0; i < u32(o + 12); i++) {
        ö(u32(o + 16) + (i * 32), get_hwvx_mysterious_24t6_16)
    }

    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + (i * 32), get_hwvx_mysterious_24t6_16)
    }

    for (let i = 0; i < u32(o + 28); i++) {
        ö(u32(o + 32) + (i * 12), get_hwvx_mysterious_24t6_32)
    }
    ö(u32(o + 36), get_hwvx_mysterious_24t6_36)
    ö(u32(o + 40), get_hwvx_mysterious_24t6_40)

}
function get_hwvx_mysterious_24t6_36(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, f32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_mysterious_24t6_40(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, f32, 8, u32, 12, f32, 16, u32, 20, u32, 24, u32, 28, ], o)
}

function get_hwvx_mysterious_24t6_16(o) {
    if (u32(o + 12) || u8(o + 18) || u8(o + 19) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, f32, 20, u32, 24, u32, 28], o)
}
function get_hwvx_mysterious_24t6_32(o) {
    if (u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}

function get_hwvx_mysterious_24t7(o) {
    ...
    for (let i = 0; i < u32(o + 68); i++) {
        ö(u32(o + 72) + (i * 12), get_hwvx_mysterious_24t7_72)
    }
    ö(u32(o + 80), get_hwvx_mysterious_24t7_80)
    ö(u32(o + 88), get_hwvx_mysterious_24t7_88)

}

function get_hwvx_mysterious_24t7_72(o) {
    if (u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}
function get_hwvx_mysterious_24t7_80(o) {
    if (u8(o + 3) || u32(o + 4) || u32(o + 8))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8], o)
}
function get_hwvx_mysterious_24t7_88(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ß('p_texture', o, 0)
}

function get_hwvx_mysterious_24t9(o) {
    ...
    ö(u32(o + 28), get_hwvx_mysterious_24t9_28)
    ö(u32(o + 32), get_hwvx_mysterious_24t9_32)

}

function get_hwvx_mysterious_24t9_28(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_mysterious_24t9_32(o) {// ü(1, [u8, 0, u8, 1, u8, 2, u8, 3], o)
}
function get_hwvx_mysterious_24t99(o) {
    ü(3, [u32, 0], o)
    //ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_mysterious_24t10(o) {
    if (u32(o + 0) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 32), get_hwvx_mysterious_24t10_8)
    }

}

function get_hwvx_mysterious_24t10_8(o) {
    ...
    ö(u32(o + 24), get_hwvx_mysterious_24t10_8_24)

}

function get_hwvx_mysterious_24t10_8_24(o) {
    ...
    for (let i = 0; i < u32(o + 12); i++) {
        ö(u32(o + 16) + (i * 32), get_hwvx_mysterious_24t10_8_24_16)
    }
    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + (i * 32), get_hwvx_mysterious_24t10_8_24_16)
    }
    for (let i = 0; i < u32(o + 28); i++) {
        ö(u32(o + 32) + (i * 12), get_hwvx_mysterious_24t10_8_24_32)
    }
    ö(u32(o + 44), get_hwvx_mysterious_24t10_8_24_44)

}

function get_hwvx_mysterious_24t10_8_24_16(o) {
    if (u32(o + 12) || u8(o + 17) || u8(o + 18) || u8(o + 19) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, f32, 20, u32, 24, u32, 28], o)
}
function get_hwvx_mysterious_24t10_8_24_24(o) {
    ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
function get_hwvx_mysterious_24t10_8_24_32(o) {
    if (u8(o + 5) || u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}
function get_hwvx_mysterious_24t10_8_24_44(o) {
    if (u32(o + 12) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, f32, 16, f32, 20, u32, 24, u32, 28, ], o)
}
...
function get_hwvx_world_idk(o) {
    ...
    for (let i = 0; i < u32(o + 44); i++) {
        ö(u32(o + 48) + (i * 12), get_hwvx_world_idk_48)
    }

}

function get_hwvx_world_idk_48(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8], o)
    ä(hwvx_some_world_thing, u32(o + 0), get_hwvx_some_world_thing)
    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 12), get_hwvx_world_idk_48_8)
    }

}

function get_hwvx_some_world_thing(o) {
    ...
    ö(u32(o + 116), get_hwvx_string)
    // HW_Cars
    ö(u32(o + 88), get_hwvx_some_world_thing_88)

}
function get_hwvx_some_world_thing_88(o) {
    if (u8(o + 0) || u8(o + 1) || u8(o + 2) !== 1 || u8(o + 3) || u8(o + 4) || u8(o + 5) || u16(o + 6) !== 1 || u32(o + 8) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u16, 6, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
}

function get_hwvx_world_idk_48_8(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8], o)

    ä(hwvx_some_world_thing, u32(o + 0), get_hwvx_some_world_thing)
    ö(u32(o + 8), get_hwvx_world_idk_48_8_8)

}

function get_hwvx_world_idk_48_8_8(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ä(hwvx_some_world_thing, u32(o + 0), get_hwvx_some_world_thing)

}
function get_hwvx_world_small_section(o) {
    // ü(1, [u8, 0,u8, 1,u8, 2,u8, 3, u32, 4, f32, 8, u32, 12, ], o)
    ö(u32(o + 12), get_hwvx_world_small_section_12)

}
function get_hwvx_world_small_section_12(o) {
...
function get_hwvx_interface_16_20t2_4(o) {
    ...
    ä(hwvx_interface_text_related, u32(o + 20), get_hwvx_interface_text_related)
...
function get_hwvx_interface_text_related(o) {
    ...
    ö(u32(o + 12), get_hwvx_interface_text_related_12)
    for (let i = 0; i < u32(o + 16); i++) {
        ö(u32(o + 20) + (i * 16), get_hwvx_interface_text_related_20)
    }
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 16), get_hwvx_interface_text_related_20)
    }
    for (let i = 0; i < u32(o + 44); i++) {
        ö(u32(o + 48) + (i * 16), get_hwvx_interface_text_related_20)
    }
    ö(u32(o + 52), get_hwvx_interface_text_related_52)

}

function get_hwvx_interface_text_related_12(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_interface_text_related_20(o) {
    if (u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 4), get_hwvx_interface_text_related_20_4)
    }

}

function get_hwvx_interface_text_related_20_4(o) {
    ß('p_texture', o, 0)
}

function get_hwvx_interface_text_related_52(o) {
...
function get_hwvx_interface_16_68_20_8_0t11_4(o) {
    ...
    switch (u8(o)) {
    case 2:
        ä(hwvx_interface_unknown, u32(o + 4), get_hwvx_interface_unknown)
        break
    case 3:
...
function get_hwvx_interface_unknown(o) {
    if (u32(o + 8) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)

    ö(u32(o + 0), get_hwvx_interface_unknown_0)
    ö(u32(o + 4), get_hwvx_interface_unknown_4)

}

function get_hwvx_interface_unknown_0(o) {
    if (u32(o + 8) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
    ö(u32(o + 4), get_hwvx_interface_unknown_0_4)

}

function get_hwvx_interface_unknown_0_4(o) {
    if (u8(o + 1) || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u16, 2, u32, 4, u32, 8, u32, 12, ], o)
}

function get_hwvx_interface_unknown_4(o) {
    if (u8(o + 1) || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u16, 2, u32, 4, u32, 8, u32, 12, ], o)
}
...
function get_hwvx_unknown_4(o) {
    ...
    switch (u32(o)) {
    case 1:
        ä(hwvx_unknown_thing, u32(o + 4), get_hwvx_unknown_thing)
        ö(u32(o + 8), get_hwvx_unknown_4_8t1)
        break
    case 2:
        ä(hwvx_asdf, u32(o + 4), get_hwvx_asdf)
        ö(u32(o + 8), get_hwvx_unknown_4_8t1)
        break
    case 3:
    ...
    case 4:
        ...
        break
    case 5:
        ä(hwvx_unknown_idk_sec, u32(o + 4), get_hwvx_unknown_idk_sec)
        ö(u32(o + 8), get_hwvx_unknown_4_8t5)
        break
    case 6:
        ä(hwvx_world_model_related, u32(o + 4), get_hwvx_world_model_related)
        ö(u32(o + 8), get_hwvx_unknown_4_8t5)
        break
    case 7:
        ä(hwvx_grand_section, u32(o + 4), get_hwvx_grand_section)
        ö(u32(o + 8), get_hwvx_unknown_4_8t1)
        break
    case 8:
        ä(hwvx_unknown_whatever, u32(o + 4), get_hwvx_unknown_whatever)
        ö(u32(o + 8), get_hwvx_unknown_4_8t5)
        break
    case 10:
        ä(hwvx_sound_section, u32(o + 4), get_hwvx_sound_section)
    ...
    case 26:
        ...
        break
    case 29:
        ä(hwvx_unknown_small_model_link, u32(o + 4), get_hwvx_unknown_small_model_link)

        // ö(u32(o + 4), get_hwvx_unknown_small_model_link)
        ö(u32(o + 8), get_hwvx_unknown_4_8t1)
        break
    case 30:
        break
...
function get_hwvx_unknown_thing(o) {
    ...
    switch (u8(o)) {
    case 0:
        ö(u32(o + 4), get_hwvx_unknown_thing_4t0)
        break
    case 1:
        ö(u32(o + 4), get_hwvx_unknown_thing_4t1)
        break
    case 2:
        ö(u32(o + 4), get_hwvx_unknown_thing_4t2)
        break
    default:
        if (u32(o + 4)) {
            console.log(o)
    ...
    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + i * 12, get_hwvx_unknown_thing_24)
    }
    ö(u32(o + 32), get_hwvx_unknown_thing_32)

}

function get_hwvx_unknown_thing_4t0(o) {
    ...
    for (let i = 0; i < u32(o + 32); i++) {
        ö(u32(o + 36) + (i * 4), get_hwvx_unknown_thing_4t0_36)
    }
    for (let i = 0; i < u32(o + 40); i++) {
        ö(u32(o + 44) + (i * 32), get_hwvx_unknown_thing_4t0_44)
    }

}

function get_hwvx_unknown_thing_4t0_36(o) {
    // ü(1, [u32, 0 ], o)
    ß('p_model', o, 0)

}
function get_hwvx_unknown_thing_4t0_44(o) {
    if (u32(o + 12) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28], o)
}

function get_hwvx_unknown_thing_4t1(o) {
    ...
    for (let i = 0; i < u32(o + 32); i++) {
        ö(u32(o + 36) + (i * 4), get_hwvx_unknown_thing_4t1_36)
    }
    for (let i = 0; i < u32(o + 40); i++) {
        ö(u32(o + 44) + (i * 12), get_hwvx_unknown_thing_4t1_44)
    }

}

function get_hwvx_unknown_thing_4t1_36(o) {
    ß('p_texture', o, 0)

    // ü(1, [u8, 0], o)
}
function get_hwvx_unknown_thing_4t1_44(o) {
    if (u8(o + 4) || u8(o + 6) || u8(o + 7))
        ü(1, [f32, 0, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}

function get_hwvx_unknown_thing_4t2(o) {
    if (u8(o + 2) || u8(o + 3) || u32(o + 28))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, f32, 4, f32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)

    for (let i = 0; i < u32(o + 12); i++) {
        ö(u32(o + 16) + (i * 12), get_hwvx_unknown_thing_4t2_16)
    }
    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + (i * 12), get_hwvx_unknown_thing_4t2_24)
    }

}

function get_hwvx_unknown_thing_4t2_16(o) {
    if (f32(o + 4))
        ü(1, [f32, 0, f32, 4, f32, 8], o)
}
function get_hwvx_unknown_thing_4t2_24(o) {
    if (u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}

function get_hwvx_unknown_thing_24(o) {
    // ü(3, [u32, 0], o) 
    if (u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}
function get_hwvx_unknown_thing_32(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)
...
function get_hwvx_unknown_idk_sec(o) {
    ...
    ö(u32(o + 28), get_hwvx_unknown_idk_sec_28)
    ö(u32(o + 32), get_hwvx_unknown_idk_sec_32)
    ö(u32(o + 36), get_hwvx_unknown_idk_sec_36)
    ö(u32(o + 40), get_hwvx_unknown_idk_sec_40)
    ö(u32(o + 48), get_hwvx_unknown_idk_sec_48)

}

function get_hwvx_unknown_idk_sec_28(o) {
...
function get_hwvx_unknown_idk_sec_32(o) {
    if (u8(o + 1) || u8(o + 2) || u8(o + 3) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 12), get_hwvx_unknown_idk_sec_32_8)
    }

}

function get_hwvx_unknown_idk_sec_32_8(o) {
    if (u8(o + 3) !== 255 || u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}
function get_hwvx_unknown_idk_sec_36(o) {
    if (u32(o + 0) !== 2 || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ö(u32(o + 4), get_hwvx_unknown_idk_sec_36_4)

}

function get_hwvx_unknown_idk_sec_36_4(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12) || u8(o + 16) || u8(o + 18) || u8(o + 19) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, f32, 20, u32, 24, u32, 28, ], o)
}

function get_hwvx_unknown_idk_sec_40(o) {
    if (u32(o + 0) !== 2 || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 16), get_hwvx_unknown_idk_sec_40_4)
    }

}

function get_hwvx_unknown_idk_sec_40_4(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, f32, 4, u32, 8, u32, 12], o)
}

function get_hwvx_unknown_idk_sec_48(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, f32, 4, u32, 8, u32, 12, ], o)
}

function get_hwvx_grand_section(o) {
    ...
    ä(hwvx_car_link, u32(o + 16), get_hwvx_car_link)
    ö(u32(o + 28), get_hwvx_mysterious)

}
function get_hwvx_unknown_whatever(o) {
    if (u8(o + 0) || u8(o + 1) !== 1 || u8(o + 2) || u8(o + 3) !== 2 || u32(o + 8) || u32(o + 12) !== 2 || u32(o + 28))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)

    for (let i = 0; i < u32(o + 12); i++) {
        ö(u32(o + 16) + (i * 12), get_hwvx_unknown_whatever_16)
    }
    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + (i * 12), get_hwvx_unknown_whatever_24)
    }

}

function get_hwvx_unknown_whatever_16(o) {
    if (u32(o + 4))
        ü(1, [f32, 0, u32, 4, f32, 8], o)
}
function get_hwvx_unknown_whatever_24(o) {
    if (u8(o + 3) !== 255 || u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}

function get_hwvx_asdf(o) {
    ...
    switch (u8(o + 4)) {
    case 1:
        ö(u32(o + 12), get_hwvx_asdf_12t1)
        break
    case 2:
        ö(u32(o + 12), get_hwvx_asdf_12t2)
        break
    default:
        if (u32(o + 12)) {
            console.log("?")
    ...
    for (let i = 0; i < u32(o + 140); i++) {
        ö(u32(o + 144) + (i * 32), get_hwvx_asdf_144)
    }

    for (let i = 0; i < u32(o + 148); i++) {
        ö(u32(o + 152) + (i * 12), get_hwvx_asdf_152)
    }
    for (let i = 0; i < u32(o + 156); i++) {
        ö(u32(o + 160) + (i * 32), get_hwvx_mysterious)
    }
    ö(u32(o + 164), get_hwvx_asdf_164)
    ö(u32(o + 168), get_hwvx_asdf_168)
    ö(u32(o + 172), get_hwvx_asdf_172)

}

function get_hwvx_asdf_12t1(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_asdf_12t2(o) {
    if (f32(o + 0) !== 50 || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_asdf_164(o) {
    if (u32(o + 4) || u32(o + 20))
        ü(1, [f32, 0, u32, 4, f32, 8, f32, 12, f32, 16, u32, 20, f32, 24, f32, 28, f32, 32, f32, 36, f32, 40, f32, 44, ], o)
}
function get_hwvx_asdf_168(o) {
...
function get_hwvx_asdf_144(o) {
    if (u32(o + 12) || u32(o + 16) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28, ], o)
}
function get_hwvx_asdf_152(o) {
    if (u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}

function get_hwvx_asdf_172(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}

function get_hwvx_unknown_small_model_link(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o + 8); i++) {
        ö(u32(o + 12) + (i * 48), get_hwvx_unknown_small_model_link_12)
    }

}

function get_hwvx_unknown_small_model_link_12(o) {
    if (u32(o + 12) || u32(o + 36) || u32(o + 40) || u32(o + 44))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, f32, 16, f32, 20, f32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)

    ß('p_model', o, 28)
    ä(hwvx_unknown_link_section, u32(o + 32), get_hwvx_unknown_link_section)

}

function get_hwvx_unknown_link_section(o) {
    ...
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 4), get_hwvx_unknown_link_section_28)
    }

}

function get_hwvx_unknown_link_section_28(o) {
    // ü(1, [u32, 0 ], o)
    ä(hwvx_unknown, u32(o + 0), get_hwvx_unknown)
...
function get_hwvx_item(o) {
    ...
    for (let i = 0; i < u32(o + 56); i++) {
        ö(u32(o + 60) + (i * 32), get_hwvx_mysterious)
    }
...
function get_hwvx_item_48_0(o) {
    ...
    for (let i = 0; i < u32(o + 44); i++) {
        ö(u32(o + 48) + (i * 32), get_hwvx_mysterious)
    }
...
function get_hwvx_geo_list(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 20), get_hwvx_geo_list_4)
    }

}

function get_hwvx_geo_list_4(o) {
    if (u8(o + 15) !== 255)
        ü(1, [u32, 0, u32, 4, u32, 8, u8, 12, u8, 13, u8, 14, u8, 15, u32, 16], o)

    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 8) + (i * 4), get_hwvx_geo_list_4_8)
    }
    ö(u32(o + 4), get_hwvx_geo_list_4_4)
    // ö(u32(o + 16), get_hwvx_geo_list_4_16)
    if (old_log_array.p_offset.array.includes(o + 16 - offset_mid)) {
            ü(1, [u32, 0, u32, 4, u32, 8, u8, 12, u8, 13, u8, 14, u8, 15, u32, 16], o)
}
}

function get_hwvx_geo_list_4_4(o) {// ü(3, [u32, 0], o) 
// ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_hwvx_geo_list_4_8(o) {// ü(3, [u32, 0], o) 
// ü(1, [f32, 0], o)
}
function get_hwvx_geo_list_4_16(o) {// ü(3, [u32, 0], o) 
// ü(1, [u8, 0], o)
...
function get_hwvx_model_gc_8_12(o) {
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
}
...
function get_hwvx_model_pc_8(o) {
   ...
   // }
    ...
    // ö(u32(o + 20), get_hwvx_string)
    // 20 sometimes links to get_hwvx_model_pc_8 ????
