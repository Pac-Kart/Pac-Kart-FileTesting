function x_mm() {
    ...
    globalThis.mm_interface = []
    globalThis.mm_models = []
    globalThis.mm_texture_anims = []
    globalThis.mm_object = []
    globalThis.mm_unknown = []
    globalThis.mm_model_anims_1 = []
    globalThis.mm_model_anims_2 = []
    globalThis.mm_car_text_related = []
    globalThis.mm_car_model_sec = []
    globalThis.mm_strange = []
    globalThis.mm_unknown_thing = []
    globalThis.mm_asdf = []
    globalThis.mm_unknown_idk_sec = []
    globalThis.mm_unknown_some_values = []
    globalThis.mm_another_unknown_sec = []
    globalThis.mm_item_maybe = []
    globalThis.mm_asdf_some_list = []
    globalThis.mm_some_model_link = []
    globalThis.mm_model_anims_1_36 = []
    globalThis.mm_model_anims_1_44 = []
    globalThis.mm_item_unknown_link = []
...
function get_mm_model_texture_anims_list(o) {
    ...
    ä(mm_texture_anims, u32(o + 0), get_mm_texture_anims)
    ä(mm_models, u32(o + 4), get_mm_model)

}

function get_mm_texture_anims(o) {
    if (u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)

    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 12), get_mm_texture_anims_8)
    }
    for (let i = 0; i < u32(o + 12); i++) {
        ö(u32(o + 16) + (i * 16), get_mm_texture_anims_16)
    }
    ö(u32(o + 20), get_mm_texture_anims_20)

}

function get_mm_texture_anims_16(o) {// ü(1, [f32, 0, f32, 4, f32, 8, u32, 12], o)
}
function get_mm_texture_anims_20(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 4), get_mm_texture_anims_20_4)
    }

}

function get_mm_texture_anims_20_4(o) {
    /*ü(1, [u32, 0], o)*/
    ß('p_texture', o, 0)

}

function get_mm_texture_anims_8(o) {
    if (u8(o + 3) !== 255)
...
function get_mm_model_8_8(o) {
    if (u16(o + 0) || u32(o + 8) || u8(o + 18) || u8(o + 19) || u8(o + 21))
        ü(1, [u16, 0, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, u32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, u8, 20, u8, 21, u8, 22, u8, 23, u32, 24, u32, 28], o)
    ß('p_texture', o, 24)
...
function get_mm_model_8_8_12t36(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 32,192
}
function get_mm_model_8_8_12t37(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 96,112
}
function get_mm_model_8_8_12t45(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 48,64,80
}
function get_mm_model_8_8_12t46(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 
}
function get_mm_model_8_8_12t47(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 32,48,64,80,96
}
function get_mm_model_8_8_12t48(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 48,64,96
}
function get_mm_model_8_8_12t55(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    // 32,48,64
}
...
function get_mm_model_8_8_12(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u16, 16, u8, 18, u8, 19], o)

    if (u8(o + 19) === 96) {// normal ??? no offsets
    } else {
        ...
        for (let i = 0; i < amount; i++) {
            // ü(1, [u8, 0,u8, 1,u8, 2,u8, 3,u32, 4], new_o + (i * 8))
            ö(u32(new_o + (i * 8) + 4), get_mm_model_8_8_12_sec_3)
        }
...
function get_mm_model_8_8_12_sec2(o) {// ü(1, [f32, 0, f32, 4, f32, 8, f32, 12], o)
// ü(1, [u32, 0, u32, 4, u32, 8, u32, 12], o)
}

function get_mm_model_8_8_12_sec_3(o) {// ü(1, [f32, 0], o)
}
function get_mm_model_8_8_12_20(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
}
function get_mm_model_8_8_12_28(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
    // 720 bytes?
}
function get_mm_model_8_8_12_36(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
}
function get_mm_model_8_8_12_44(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
}
function get_mm_model_8_8_12_52(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
}
function get_mm_model_8_8_12_60(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
}
function get_mm_model_8_8_12_68(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [f32, 0], o)
}
...
function get_mm_texture_8(o) {// ü(1, [f32, 0], o)
}
...
function get_mm_car(o) {
    if (u8(o + 0) || u8(o + 1) !== 50 || u8(o + 2) !== 88 || u8(o + 3) !== 2 || u32(o + 12) || u32(o + 16) !== 50 || f32(o + 60) !== 5000 || f32(o + 64) !== 10 || u32(o + 72) || u32(o + 80) || u32(o + 116) || u32(o + 128) !== 14711136 || u32(o + 148) || u32(o + 168) || u32(o + 188) || u32(o + 192) || u32(o + 196) || u32(o + 200) !== 3 || u32(o + 216) || u32(o + 220) || u32(o + 224) !== 5 || u32(o + 232) !== 7 || u32(o + 240) !== 4 || u32(o + 248) || u32(o + 252))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, f32, 20, f32, 24, f32, 28, f32, 32, f32, 36, f32, 40, f32, 44, f32, 48, f32, 52, f32, 56, f32, 60, f32, 64, f32, 68, u32, 72, f32, 76, u32, 80, f32, 84, u32, 88, u32, 92, u32, 96, u32, 100, u32, 104, u32, 108, u32, 112, u32, 116, u32, 120, u32, 124, u32, 128, u32, 132, u32, 136, u32, 140, u32, 144, u32, 148, u32, 152, u32, 156, u32, 160, u32, 164, u32, 168, u32, 172, u32, 176, u32, 180, u32, 184, u32, 188, u32, 192, u32, 196, u32, 200, u32, 204, u32, 208, u32, 212, u32, 216, u32, 220, u32, 224, u32, 228, u32, 232, u32, 236, u32, 240, u32, 244, u32, 248, u32, 252], o)
    ß('p_texture', o, 88)
    ß('p_texture', o, 100)

    ä(mm_model_anims_1, u32(o + 92), get_mm_model_anims_1)
    ä(mm_model_anims_2, u32(o + 96), get_mm_model_anims_2)
    ...
    ö(u32(o + 172), get_mm_car_section)
    ö(u32(o + 176), get_mm_car_section)
    //same as 172
    ö(u32(o + 180), get_mm_car_section)
    //same as 172
    ö(u32(o + 184), get_mm_car_section)
    //same as 172
...
function get_mm_unknown_4(o) {
    switch (u32(o)) {
    case 1:
        ä(mm_unknown_thing, u32(o + 4), get_mm_unknown_thing)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 2:
        ä(mm_asdf, u32(o + 4), get_mm_asdf)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 3:
        ...
        break
    case 4:
        ä(mm_strange, u32(o + 4), get_mm_strange)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 5:
        ä(mm_unknown_idk_sec, u32(o + 4), get_mm_unknown_idk_sec)
        ö(u32(o + 8), get_mm_unknown_4_8t8)
        break
    case 6:
        ä(mm_item_maybe, u32(o + 4), get_mm_item_maybe)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 8:
        ä(mm_asdf_some_list, u32(o + 4), get_mm_asdf_some_list)
        ö(u32(o + 8), get_mm_unknown_4_8t8)
        break
    case 10:
    ...
    case 15:
        break
    case 25:
        ä(mm_object, u32(o + 4), get_mm_object)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 26:
        ...
        break
    case 27:
        ä(mm_unknown_some_values, u32(o + 4), get_mm_unknown_some_values)
        ö(u32(o + 8), get_mm_unknown_4_8t8)
        break
    case 28:
        ä(mm_another_unknown_sec, u32(o + 4), get_mm_another_unknown_sec)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 29:
        ö(u32(o + 4), get_mm_unknown_small_model_link)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    default:
...
function get_mm_unknown_thing(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12) || u16(o + 18) || u32(o + 56) || u32(o + 72) || u32(o + 84))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u8, 16, u8, 17, u16, 18, u32, 20, u32, 24, u32, 28, f32, 32, u32, 36, u32, 40, u32, 44, u32, 48, u32, 52, u32, 56, u32, 60, u32, 64, u32, 68, u32, 72, f32, 76, f32, 80, u32, 84, f32, 88, f32, 92], o)

    switch (u8(o + 16)) {
    case 0:
        ö(u32(o + 20), get_mm_unknown_thing_20t0)
        ä(mm_models, u32(o + 52), get_mm_model)
        break
    case 1:
        ö(u32(o + 20), get_mm_unknown_thing_20t1)
        ß('p_texture', o, 52)
        break
    default:
    ...
    for (let i = 0; i < u32(o + 36); i++) {
        ö(u32(o + 40) + (i * 32), get_mm_unknown_thing_40)
    }
    for (let i = 0; i < u32(o + 44); i++) {
        ö(u32(o + 48) + (i * 12), get_mm_unknown_thing_48)
    }
    ö(u32(o + 48), get_mm_unknown_thing_48)
    ö(u32(o + 60), get_mm_unknown_thing_60)
    ä(mm_unknown, u32(o + 64), get_mm_unknown)
    ä(mm_unknown, u32(o + 68), get_mm_unknown)

}

function get_mm_unknown_thing_20t0(o) {
...
function get_mm_unknown_thing_40(o) {
    if (u32(o + 12) || u8(o + 18) || u8(o + 19) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, f32, 20, u32, 24, u32, 28], o)
}
function get_mm_unknown_thing_48(o) {
    if (u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}
function get_mm_unknown_thing_60(o) {// ü(1, [f32, 0, f32, 4, f32, 8, f32, 12, f32, 16, f32, 20, f32, 24, f32, 28, f32, 32, f32, 36, f32, 40, f32, 44, ], o)
}

function get_mm_asdf(o) {
    if (u32(o + 36) || u32(o + 40) || u32(o + 56) !== 100 || u32(o + 108) || u32(o + 144) || u32(o + 148) || u32(o + 164) || u32(o + 168) || u32(o + 172))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, f32, 44, f32, 48, f32, 52, u32, 56, f32, 60, f32, 64, f32, 68, f32, 72, f32, 76, f32, 80, u32, 84, u32, 88, u32, 92, u32, 96, u32, 100, u32, 104, u32, 108, u32, 112, u32, 116, u32, 120, u32, 124, u32, 128, u32, 132, u32, 136, u32, 140, u32, 144, u32, 148, u32, 152, u32, 156, u32, 160, u32, 164, u32, 168, u32, 172], o)

    switch (u8(o + 1)) {
    case 0:
        ä(mm_models, u32(o + 16), get_mm_model)
        break
    case 1:
        ß('p_texture', o, 16)
        break
    ...
    ö(u32(o + 12), get_mm_asdf_12)

    ß('p_texture', o, 92)
    ö(u32(o + 96), get_mm_asdf_96)
    ö(u32(o + 100), get_mm_asdf_texture_link)

    ä(mm_asdf_some_list, u32(o + 104), get_mm_asdf_some_list)
    ...
    for (let i = 0; i < u32(o + 128); i++) {
        ö(u32(o + 132) + (i * 32), get_mm_asdf_132)
    }
    for (let i = 0; i < u32(o + 136); i++) {
        ö(u32(o + 140) + (i * 12), get_mm_asdf_140)
    }

    ö(u32(o + 152), get_mm_asdf_152)
    ö(u32(o + 156), get_mm_asdf_156)
    ö(u32(o + 160), get_mm_asdf_160)

}
function get_mm_asdf_texture_link(o) {
    if (u32(o + 0) !== 7 || u32(o + 4) !== 14445632 || u8(o + 8) !== 1 || u8(o + 9) !== 1 || u8(o + 10) || u8(o + 11) || f32(o + 12) !== 500 || f32(o + 16) !== 600 || u32(o + 20) !== 14445776 || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u8, 8, u8, 9, u8, 10, u8, 11, f32, 12, f32, 16, u32, 20, u32, 24, u32, 28], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 20), get_mm_asdf_texture_link_4)
    }
    ö(u32(o + 20), get_mm_asdf_texture_link_20)

}

function get_mm_asdf_texture_link_20(o) {
...
function get_mm_asdf_texture_link_4(o) {
    /*ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, f32, 4, f32, 8, u32, 12, u32, 16], o)*/
    ß('p_texture', o, 12)
}

function get_mm_asdf_156(o) {
...
function get_mm_asdf_some_list(o) {
    if (u8(o + 2) || u32(o + 28))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28], o)

    for (let i = 0; i < u32(o + 12); i++) {
        ö(u32(o + 16) + i * 12, get_mm_asdf_some_list_16)
    }
    for (let i = 0; i < u32(o + 20); i++) {
        ö(u32(o + 24) + i * 12, get_mm_asdf_some_list_24)
    }

}

function get_mm_asdf_some_list_16(o) {
    if (u8(o + 4) || u8(o + 6) || u8(o + 7))
        ü(1, [f32, 0, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}
function get_mm_asdf_some_list_24(o) {
    if (u8(o + 4) || u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}

function get_mm_asdf_12(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_mm_asdf_132(o) {
    if (u32(o + 12) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28, ], o)
}
function get_mm_asdf_140(o) {// ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}
function get_mm_asdf_152(o) {// ü(1, [f32, 0, f32, 4, f32, 8, f32, 12, f32, 16, f32, 20, f32, 24, f32, 28, f32, 32, f32, 36, f32, 40, f32, 44, ], o)
}
function get_mm_asdf_160(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}
function get_mm_asdf_96(o) {
    if (u8(o + 2) || u8(o + 3) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28) || u32(o + 44) || u32(o + 48) || u32(o + 52) || u32(o + 56) || u32(o + 60) || u32(o + 68) || u32(o + 72) || u32(o + 76))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, f32, 32, u32, 36, f32, 40, u32, 44, u32, 48, u32, 52, u32, 56, u32, 60, u8, 64, u8, 65, u8, 66, u8, 67, u32, 68, u32, 72, u32, 76], o)

    ö(u32(o + 4), get_mm_asdf_96_4)
    switch (u8(o)) {
    case 0:
    case 1:
        ö(u32(o + 36), get_mm_asdf_96_36)
        break
    case 5:
        //floats?
        break
...
function get_mm_unknown_some_values(o) {
    if (u8(o + 3))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, f32, 16, f32, 20, u32, 24, u32, 28, ], o)
    ö(u32(o + 24), get_mm_unknown_some_values_24)
    ö(u32(o + 28), get_mm_unknown_some_values_28)

}

function get_mm_unknown_some_values_24(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)

    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + i * 12, get_mm_unknown_some_values_24_4)
    }

}
function get_mm_unknown_some_values_24_4(o) {
    if (u8(o + 6) || u8(o + 7))
        ü(1, [f32, 0, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}

function get_mm_unknown_some_values_28(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 12), get_mm_unknown_some_values_28_4)
    }

}

function get_mm_unknown_some_values_28_4(o) {
    if (u8(o + 4) || u8(o + 6) || u8(o + 7))
        ü(1, [f32, 0, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}

function get_mm_another_unknown_sec(o) {
    ...
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 12), get_mm_another_unknown_sec_28)
    }
    for (let i = 0; i < u32(o + 32); i++) {
        ö(u32(o + 36) + (i * 12), get_mm_another_unknown_sec_36)
    }

}

function get_mm_another_unknown_sec_28(o) {
    if (u8(o + 3) !== 255 || u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}
function get_mm_another_unknown_sec_36(o) {
    if (u8(o + 3) !== 255 || u32(o + 4))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}

function get_mm_unknown_small_model_link(o) {
    if (u32(o + 8) || u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 48), get_mm_unknown_small_model_link_4)
    }

}

function get_mm_unknown_small_model_link_4(o) {
    ...
    ä(mm_models, u32(o + 28), get_mm_model)
    ä(mm_strange, u32(o + 32), get_mm_strange)
...
function get_mm_car_140(o) {
    if (u32(o + 12) || u32(o + 32) || u8(o + 39) || f32(o + 40) || f32(o + 44) || u32(o + 48) || f32(o + 52) || u32(o + 56) || f32(o + 60) || u32(o + 64) || u32(o + 68) || u32(o + 72) || u32(o + 76) || f32(o + 80) || f32(o + 84) || f32(o + 88) || f32(o + 92) || f32(o + 96) || u32(o + 100) || u32(o + 104) || u32(o + 108))
    ...
    ä(mm_car_model_sec, u32(o + 16), get_mm_car_model_sec)

    ä(mm_model_anims_1, u32(o + 20), get_mm_model_anims_1)
    ä(mm_model_anims_1, u32(o + 24), get_mm_model_anims_1)
    ä(mm_model_anims_1, u32(o + 28), get_mm_model_anims_1)
...
function get_mm_car_model_sec(o) {
    ...
    ä(mm_model_anims_1, u32(o + 16), get_mm_model_anims_1)
    ä(mm_model_anims_2, u32(o + 20), get_mm_model_anims_2)
    ...
    ä(mm_some_model_link, u32(o + 56), get_mm_some_model_link)

}

function get_mm_car_model_sec_12(o) {
    // ü(1, [u32, 0, u32, 4], o)
    ä(mm_models, u32(o + 0), get_mm_model)
...
function get_mm_car_model_sec_48(o) {
    ...
    case 0:
        ...
        break
    case 1:
        ä(mm_strange, u32(o + 8), get_mm_strange)
        break
    case 6:
        ä(mm_unknown_idk_sec, u32(o + 8), get_mm_unknown_idk_sec)
        break
    case 7:
    case 10:
    case 99:
...
function get_mm_unknown_idk_sec(o) {
    if (u8(o + 2) || u32(o + 32) || u32(o + 36) || u32(o + 44))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8, f32, 12, u32, 16, u32, 20, u32, 24, f32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)
    ö(u32(o + 40), get_mm_unknown_idk_sec_40)

}

function get_mm_unknown_idk_sec_40(o) {
...
function get_mm_car_model_sec_48_12(o) {
    if (u32(o + 12) || u8(o + 17) || u8(o + 18) || u32(o + 20) || u32(o + 28))
...
function get_mm_some_model_link(o) {
    if (u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 28), get_mm_some_model_link_4)
    }
    ä(mm_model_anims_2, u32(o + 8), get_mm_model_anims_2)

}

function get_mm_some_model_link_4(o) {
    if (u8(o + 1) !== 1 || u8(o + 3) || u32(o + 20))
        ü(1, [u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24], o)

    ä(mm_models, u32(o + 8), get_mm_model)

    ö(u32(o + 12), get_mm_some_model_link_4_12)
    ö(u32(o + 16), get_mm_some_model_link_4_16)
    ä(mm_strange, u32(o + 24), get_mm_strange)

}

function get_mm_some_model_link_4_12(o) {
    if (u32(o + 12))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, ], o)
}
function get_mm_some_model_link_4_16(o) {
    if (u32(o + 12))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, ], o)
}
...
function get_mm_car_144(o) {
    ...
    ä(mm_car_model_sec, u32(o + 0), get_mm_car_model_sec)
    ä(mm_car_model_sec, u32(o + 4), get_mm_car_model_sec)
    ä(mm_car_model_sec, u32(o + 8), get_mm_car_model_sec)
    ä(mm_car_model_sec, u32(o + 12), get_mm_car_model_sec)
}
...
function get_mm_car_160(o) {
    if (u32(o + 12) || u32(o + 28) || u32(o + 32) || u32(o + 36) || u32(o + 40) || u32(o + 44) || u32(o + 60) || u32(o + 76) || u32(o + 80) || u32(o + 84) || u32(o + 88) || u32(o + 92) || f32(o + 100) !== 0.004999999888241291 || u8(o + 121) || u8(o + 123) || u32(o + 124) || f32(o + 132) !== 0.699999988079071 || f32(o + 136) !== 0.8999999761581421 || f32(o + 212) !== 0.6000000238418579 || u32(o + 244) || u32(o + 248) || u32(o + 252))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, f32, 16, f32, 20, f32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, f32, 48, f32, 52, f32, 56, u32, 60, f32, 64, f32, 68, f32, 72, u32, 76, u32, 80, u32, 84, u32, 88, u32, 92, f32, 96, f32, 100, f32, 104, f32, 108, f32, 112, f32, 116, u8, 120, u8, 121, u8, 122, u8, 123, u32, 124, f32, 128, f32, 132, f32, 136, f32, 140, f32, 144, f32, 148, f32, 152, f32, 156, f32, 160, f32, 164, f32, 168, f32, 172, f32, 176, f32, 180, f32, 184, f32, 188, f32, 192, f32, 196, f32, 200, f32, 204, f32, 208, f32, 212, u32, 216, u32, 220, u32, 224, f32, 228, u32, 232, u32, 236, u32, 240, u32, 244, u32, 248, u32, 252], o)

    ä(mm_item_unknown_link, u32(o + 216), get_mm_item_unknown_link)
...
function get_mm_car_164(o) {
    ...
    ä(mm_interface, u32(o + 16), get_mm_interface)
    ä(mm_interface, u32(o + 24), get_mm_interface)
    ä(mm_text, u32(o + 40), get_mm_text)
...
function get_mm_car_section(o) {
    ...
    for (let i = 0; i < u32(o + 40); i++) {
        ö(u32(o + 44) + (i * 120), get_mm_car_section_44)
    }

}

function get_mm_car_section_44(o) {
    ...
    for (let i = 0; i < u32(o + 96); i++) {
        ö(u32(o + 100) + (i * 4), get_mm_car_section_44_100)
    }
    ö(u32(o + 104), get_mm_car_section_44_104)
    ö(u32(o + 108), get_mm_car_section_44_108)
    ö(u32(o + 112), get_mm_car_section_44_112)
    ö(u32(o + 116), get_mm_car_section_44_116)
    ö(u32(o + 88), get_mm_car_section_44_88)

}

function get_mm_car_section_44_100(o) {
    // ü(1, [u32, 0], o)
    ä(mm_car_text_related, u32(o + 0), get_mm_car_text_related)

}

function get_mm_car_text_related(o) {
    if (u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ö(u32(o + 0), get_mm_car_text_related_0)
    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 32), get_mm_car_text_related_8)
    }

}

function get_mm_car_text_related_0(o) {// console.log(get_string(o, 0, false))
// ü(1, [f32, 0], o)
}
function get_mm_car_text_related_8(o) {
    if (u32(o + 4) || u32(o + 12))
        ü(1, [f32, 0, u32, 4, f32, 8, u32, 12, f32, 16, f32, 20, u32, 24, u32, 28, ], o)
}

function get_mm_car_section_44_104(o) {
    if (u32(o + 36) || u32(o + 40) || u32(o + 44))
        ü(1, [f32, 0, f32, 4, f32, 8, f32, 12, f32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, ], o)
}
function get_mm_car_section_44_108(o) {
    if (u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, f32, 4, f32, 8, f32, 12, f32, 16, f32, 20, u32, 24, u32, 28, ], o)
}
function get_mm_car_section_44_112(o) {
    if (u32(o + 4) || u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, u32, 4, f32, 8, u32, 12, f32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
function get_mm_car_section_44_116(o) {// console.log(get_string(o, 0, false))
// ü(1, [f32, 0], o)
}
function get_mm_car_section_44_88(o) {
    if (u8(o + 7) || u8(o + 18) || u8(o + 19) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, u32, 8, f32, 12, u8, 16, u8, 17, u8, 18, u8, 19, u32, 20, u32, 24, u32, 28], o)
...
function get_mm_car_204(o) {
    // ü(1, [u32, 0, u32, 4], o)
    ö(u32(o + 4), get_mm_car_204_4)

}

function get_mm_car_204_4(o) {
    ...
    ä(mm_text, u32(o + 100), get_mm_text)
...
function get_mm_car_236(o) {
    // ü(1, [u32, 0, u32, 4, u32, 8], o)
    for (let i = 0; i < u32(o); i++) {
        ö(u32(o + 4) + (i * 20), get_mm_car_236_4)
    }
    ä(mm_model_anims_2, u32(o + 8), get_mm_model_anims_2)

}

function get_mm_car_236_4(o) {
    if (u32(o + 16))
        ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, u32, 16], o)
    ...
    ö(u32(o + 12), get_mm_car_236_4_12)

}

function get_mm_car_236_4_12(o) {
    if (u32(o + 12) || u8(o + 17) || u8(o + 18) || u8(o + 19) !== 1 || u32(o + 20) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, u32, 20, u32, 24, u32, 28], o)

    ö(u32(o + 24), get_mm_car_236_4_12_24)

}

function get_mm_car_236_4_12_24(o) {
    if (u8(o + 3) || u32(o + 44))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)
    ...
    for (let i = 0; i < u32(o + 8); i++) {
        ö(u32(o + 12) + (i * 32), get_mm_car_236_4_12_24_12)
    }
    for (let i = 0; i < u32(o + 16); i++) {
        ö(u32(o + 20) + (i * 32), get_mm_car_236_4_12_24_20)
    }
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 12), get_mm_car_236_4_12_24_28)
    }
    ö(u32(o + 32), get_mm_car_236_4_12_24_32)
    ö(u32(o + 36), get_mm_car_236_4_12_24_36)
    ö(u32(o + 40), get_mm_car_236_4_12_24_40)

}

function get_mm_car_236_4_12_24_12(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28], o)
}
function get_mm_car_236_4_12_24_20(o) {
    if (u32(o + 12) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, f32, 20, u32, 24, u32, 28], o)
}
function get_mm_car_236_4_12_24_28(o) {
    if (u8(o + 3) !== 255 || u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}
function get_mm_car_236_4_12_24_32(o) {
    if (f32(o + 0) !== 100 || f32(o + 4) !== 300 || u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, f32, 4, u32, 8, u32, 12], o)
}
function get_mm_car_236_4_12_24_36(o) {
    if (u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, f32, 16, u32, 20, u32, 24, u32, 28], o)
}
function get_mm_car_236_4_12_24_40(o) {
...
function get_mm_object(o) {
    ...
    ä(mm_models, u32(o + 20), get_mm_model)
    ä(mm_text, u32(o + 72), get_mm_text)
    ä(mm_unknown, u32(o + 76), get_mm_unknown)
    ä(mm_unknown, u32(o + 80), get_mm_unknown)

    ö(u32(o + 88), get_mm_object_link)
    ö(u32(o + 92), get_mm_object_92)
    for (let i = 0; i < u32(o + 96); i++) {
        ö(u32(o + 100) + (i * 20), get_mm_object_100)
    }

}

function get_mm_object_link(o) {
    ...
    ß('p_texture', o, 24)
    ä(mm_car_model_sec, u32(o + 0), get_mm_car_model_sec)
    ä(mm_text, u32(o + 16), get_mm_text)

    ä(mm_unknown, u32(o + 20), get_mm_unknown)
    ä(mm_model_anims_2, u32(o + 28), get_mm_model_anims_2)

}

function get_mm_object_92(o) {
    if (u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, ], o)
}
function get_mm_object_100(o) {
    if (u32(o + 0) || u32(o + 8) || u32(o + 16))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16], o)
    ö(u32(o + 12), get_mm_object_100_12)

}

function get_mm_object_100_12(o) {
    ...
    ö(u32(o + 24), get_mm_object_100_12_24)

}

function get_mm_object_100_12_24(o) {
    ...
    ö(u32(o + 12), get_mm_object_100_12_24_12)
    ö(u32(o + 20), get_mm_object_100_12_24_20)
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 12), get_mm_object_100_12_24_28)
    }
    ...
    ö(u32(o + 40), get_mm_object_100_12_24_40)

}

function get_mm_object_100_12_24_12(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
function get_mm_object_100_12_24_20(o) {
    if (u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
function get_mm_object_100_12_24_28(o) {
    if (u8(o + 3) !== 255)
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}
function get_mm_object_100_12_24_40(o) {
    if (u32(o + 0) || u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, f32, 4, f32, 8, u32, 12, f32, 16, u32, 20, u32, 24, u32, 28, ], o)
}

function get_mm_car_link_the_third(o) {
    ...
    ö(u32(o + 32), get_mm_car_3_texture_link)

    ä(mm_interface, u32(o + 36), get_mm_interface)
    ä(mm_interface, u32(o + 40), get_mm_interface)

    ä(mm_item_maybe, u32(o + 44), get_mm_item_maybe)

}

function get_mm_car_3_texture_link(o) {
    if (u32(o + 0) !== 110 || u32(o + 4) || u8(o + 8) || u8(o + 9) !== 16 || u8(o + 10) !== 16 || u8(o + 11) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) !== 1 || u32(o + 28) !== 14207392 || u32(o + 32) || u32(o + 36) || u32(o + 40) || u32(o + 44))
        ü(1, [u32, 0, u32, 4, u8, 8, u8, 9, u8, 10, u8, 11, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)
    ß('p_texture', o, 0)

    ö(u32(o + 28), get_mm_car_3_texture_link_28)

}

function get_mm_car_3_texture_link_28(o) {
    if (u32(o + 0) || u32(o + 4) || u32(o + 8) || u32(o + 12) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
}

function get_mm_item_maybe(o) {
    ...
    ö(u32(o + 20), get_mm_item_maybe_20)
    ...
    ä(mm_item_unknown_link, u32(o + 44), get_mm_item_unknown_link)
    ö(u32(o + 48), get_mm_item_maybe_48)

    for (let i = 0; i < u32(o + 56); i++) {
        ö(u32(o + 60) + (i * 20), get_mm_item_maybe_60)
    }
    for (let i = 0; i < u32(o + 64); i++) {
        ö(u32(o + 68) + (i * 4), get_mm_item_maybe_68)
    }

    ä(mm_model_anims_2, u32(o + 72), get_mm_model_anims_2)
    ä(mm_models, u32(o + 76), get_mm_model)

}

function get_mm_item_maybe_60(o) {
    if (f32(o + 0) || u32(o + 16))
        ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, u32, 16], o)

    ä(mm_strange, u32(o + 8), get_mm_strange)

    ö(u32(o + 12), get_mm_item_maybe_60_12)

}

function get_mm_item_maybe_60_12(o) {
    if (u32(o + 12) || u8(o + 16) || u8(o + 17) || u8(o + 18) || u8(o + 19) !== 1 || u32(o + 20) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, u32, 20, u32, 24, u32, 28], o)

    ö(u32(o + 24), get_mm_item_maybe_60_12_24)

}

function get_mm_item_maybe_60_12_24(o) {
    if (u32(o + 0) || u32(o + 8) || u32(o + 12) || u32(o + 32) || u32(o + 36) || u32(o + 44))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)

    ä(mm_models, u32(o + 4), get_mm_model)

    for (let i = 0; i < u32(o + 16); i++) {
        ö(u32(o + 20) + (i * 32), get_mm_item_maybe_60_12_24_20)
    }
    for (let i = 0; i < u32(o + 24); i++) {
        ö(u32(o + 28) + (i * 12), get_mm_item_maybe_60_12_24_28)
    }

    ö(u32(o + 40), get_mm_item_maybe_60_12_24_40)

}

function get_mm_item_maybe_60_12_24_20(o) {
    if (u32(o + 12) || u8(o + 18) || u8(o + 19) || u32(o + 24) || u32(o + 28))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u8, 16, u8, 17, u8, 18, u8, 19, f32, 20, u32, 24, u32, 28], o)
}
function get_mm_item_maybe_60_12_24_28(o) {
    if (u8(o + 3) !== 255 || u8(o + 5) || u8(o + 6) || u8(o + 7))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u8, 4, u8, 5, u8, 6, u8, 7, f32, 8], o)
}
function get_mm_item_maybe_60_12_24_40(o) {
    if (u32(o + 0) || u32(o + 4) || f32(o + 8) !== 1 || u32(o + 12) || u32(o + 20) || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, f32, 8, u32, 12, f32, 16, u32, 20, u32, 24, u32, 28], o)
}

function get_mm_item_maybe_48(o) {
    if (f32(o + 0) !== 100 || u32(o + 4) || u32(o + 8) || u32(o + 12))
        ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, ], o)
}

function get_mm_item_maybe_20(o) {
    if (u32(o + 12))
        ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}

function get_mm_item_maybe_68(o) {
    // ü(1, [u32, 0], o)
    ä(mm_unknown, u32(o + 0), get_mm_unknown)

}

function get_mm_item_unknown_link(o) {
    if (u8(o + 2) || u8(o + 3) || u32(o + 4) || u32(o + 16) || u32(o + 20) || u32(o + 24) || u32(o + 28) || u32(o + 32) || u32(o + 36) || u32(o + 40) || u32(o + 44) || u32(o + 56) || u32(o + 60))
        ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8, f32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, u32, 48, u32, 52, u32, 56, u32, 60], o)

    ä(mm_unknown, u32(o + 48), get_mm_unknown)
    ä(mm_unknown_thing, u32(o + 52), get_mm_unknown_thing)
...
function get_mm_interface_16_16t1(o) {
    ...
    ä(mm_text, u32(o), get_mm_text)
    ä(mm_font, u32(o + 4), get_mm_font)
...
function get_mm_world(o) {
    ...
    for (let i = 0; i < u32(o + 160); i++) {
        ä(mm_world_164, u32(o + 164) + (i * 96), get_mm_world_164)
    }
...
function get_mm_world_52(o) {
    if (u8(o + 15) !== 255 || u8(o + 31) !== 255 || u8(o + 47) !== 255 || u8(o + 68) !== 205 || u8(o + 69) !== 205 || u8(o + 70) !== 205 || u8(o + 71) !== 205 || u8(o + 72) !== 205 || u8(o + 73) !== 205 || u8(o + 74) !== 205 || u8(o + 75) !== 205 || u8(o + 76) !== 205 || u8(o + 77) !== 205 || u8(o + 78) !== 205 || u8(o + 79) !== 205)
        ü(1, [f32, 0, f32, 4, f32, 8, u8, 12, u8, 13, u8, 14, u8, 15, f32, 16, f32, 20, f32, 24, u8, 28, u8, 29, u8, 30, u8, 31, f32, 32, f32, 36, f32, 40, u8, 44, u8, 45, u8, 46, u8, 47, u8, 48, u8, 49, u8, 50, u8, 51, u8, 52, u8, 53, u8, 54, u8, 55, u8, 56, u8, 57, u8, 58, u8, 59, u8, 60, u8, 61, u8, 62, u8, 63, u32, 64, u8, 68, u8, 69, u8, 70, u8, 71, u8, 72, u8, 73, u8, 74, u8, 75, u8, 76, u8, 77, u8, 78, u8, 79], o)

    ä(mm_item_unknown_link, u32(o + 64), get_mm_item_unknown_link)
...
function get_mm_world_100(o) {
    ...
    ä(mm_item_maybe, u32(o + 40), get_mm_item_maybe)
...
function get_mm_world_124(o) {
    if (u32(o + 12) || f32(o + 28) !== 10000 || u32(o + 36) || u8(o + 40) || u8(o + 42) || u8(o + 43))
        ü(1, [f32, 0, f32, 4, f32, 8, u32, 12, u32, 16, u32, 20, u32, 24, f32, 28, u32, 32, u32, 36, u8, 40, u8, 41, u8, 42, u8, 43, f32, 44], o)
...
function get_mm_world_132(o) {
    if (u8(o + 12) !== 205 || u8(o + 13) !== 205 || u8(o + 14) !== 205 || u8(o + 15) !== 205 || u32(o + 24) || u32(o + 52) || u32(o + 56) || u32(o + 60))
        ü(1, [f32, 0, f32, 4, f32, 8, u8, 12, u8, 13, u8, 14, u8, 15, f32, 16, f32, 20, u32, 24, f32, 28, u32, 32, u32, 36, u32, 40, f32, 44, u32, 48, u32, 52, u32, 56, u32, 60], o)

    ä(mm_strange, u32(o + 36), get_mm_strange)
    ö(u32(o + 40), get_mm_world_later)

}

function get_mm_world_140(o) {
    if (u8(o + 12) !== 205 || u8(o + 13) !== 205 || u8(o + 14) !== 205 || u8(o + 15) !== 205 || u32(o + 40) || u32(o + 44) || u32(o + 48) || u8(o + 56) || u8(o + 58) || u8(o + 59) || u32(o + 60))
        ü(1, [f32, 0, f32, 4, f32, 8, u8, 12, u8, 13, u8, 14, u8, 15, f32, 16, f32, 20, f32, 24, f32, 28, u32, 32, u32, 36, u32, 40, u32, 44, u32, 48, f32, 52, u8, 56, u8, 57, u8, 58, u8, 59, u32, 60], o)
    ä(mm_item_maybe, u32(o + 36), get_mm_item_maybe)
}
...
function get_mm_world_164(o) {
    ...
    ä(mm_unknown, u32(o + 68), get_mm_unknown)
    ä(mm_strange, u32(o + 72), get_mm_strange)
    ...
    if (u32(o + 80)) {
        ...
        ä(mm_world_164, u32(o + 88), get_mm_world_164)
    }

}

function get_mm_world_164_88(o) {/*ü(1, [u32, 0], o)*/
}
...
function get_mm_world_180_0(o) {
    if (u8(o + 12) !== 205 || u8(o + 13) !== 205 || u8(o + 14) !== 205 || u8(o + 15) !== 205 || u8(o + 62) || u8(o + 63) || u8(o + 64) || u8(o + 65) !== 128 || u8(o + 66) !== 255 || u8(o + 67) !== 255 || u32(o + 68) || u32(o + 72))
        ü(1, [f32, 0, f32, 4, f32, 8, u8, 12, u8, 13, u8, 14, u8, 15, f32, 16, f32, 20, f32, 24, f32, 28, u8, 32, u8, 33, u8, 34, u8, 35, u8, 36, u8, 37, u8, 38, u8, 39, u8, 40, u8, 41, u8, 42, u8, 43, u8, 44, u8, 45, u8, 46, u8, 47, f32, 48, u32, 52, f32, 56, u8, 60, u8, 61, u8, 62, u8, 63, u8, 64, u8, 65, u8, 66, u8, 67, u32, 68, u32, 72, u32, 76], o)
}
...
function get_mm_world_later_32(o) {
    if (u32(o + 0) !== 14 || u8(o + 8) !== 1 || u8(o + 9) !== 1 || u8(o + 10) || u8(o + 11) || f32(o + 12) !== 100000 || f32(o + 16) !== 100000 || u32(o + 24) || u32(o + 28))
        ü(1, [u32, 0, u32, 4, u8, 8, u8, 9, u8, 10, u8, 11, f32, 12, f32, 16, u32, 20, u32, 24, u32, 28], o)
