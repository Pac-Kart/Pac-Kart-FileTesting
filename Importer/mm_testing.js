function x_mm() {
    ...
    globalThis.mm_strange_20 = []
    globalThis.mm_model_anims_1_36 = []
    globalThis.mm_model_anims_1_44 = []
    globalThis.mm_item_maybe_0 = []
    globalThis.mm_car_236_4_8t1 = []
    globalThis.mm_car_236_4_8t0 = []
    globalThis.mm_car_204_4_100 = []
    globalThis.mm_car_204_4_28 = []
    globalThis.mm_car_204_4_24 = []
    globalThis.mm_car_204_4_20 = []

    globalThis.temp_check_offset_array = []
    ...
    // get_mm_check_if_offset_in_array_range()

    // print_logarray(log_array)

}

function get_mm_check_if_offset_in_array_range() {
    let array = ["texts", "fonts", "mm_sound_section", "mm_sound_controls", "interface", "models", "mm_texture_anims", "models_array", "car2", "mm_unknown", "car3_44_44", "model_anims_1", "model_anims_2", "car_120", "car_172_44_100_0", "car_144_0", "car_model_sec", "mm_strange", "car_model_sec_48_8t1", "mm_unknown_thing", "mm_asdf", "mm_unknown_4_4t5", "mm_unknown_4_4t8", "mm_unknown_some_values", "mm_another_unknown_sec", "car3_44", "mm_asdf_some_list", "car_model_sec_56_4_24", "car_140_16_56", "mm_world_52_64", "mm_world_164_72", "mm_world_148_40", "mm_world_132_36", "mm_world_132_36_20", "mm_strange_20", "mm_model_anims_1_36", "mm_model_anims_1_44", "mm_unknown_small_model_link_4_32", "mm_item_maybe_0"]

    for (let multilink_array of array) {
        let max = Math.max(...multilink_array)
        let min = Math.min(...multilink_array)

        for (let i = 0; i < temp_check_offset_array.length; i++) {
            if (temp_check_offset_array < max && temp_check_offset_array > min) {} else {}
        }
...
function get_mm_model_8_8_12t0(o) {// ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
}
function get_mm_model_8_8_12t1(o) {// probably
...
function get_mm_model_8_8_12t2(o) {// ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u8, 16,u8, 17, u8, 18, u8, 19, u32, 20, u32, 24, u32, 28], o)
...
function get_mm_unknown_4(o) {
    ...
    case 5:
        ...
        break
    case 6:
        ä(car3_44, u32(o + 4), get_mm_item_maybe)
        ö(u32(o + 8), get_mm_unknown_4_8t1)
        break
    case 8:
...
function get_mm_unknown_thing(o) {
    temp_check_offset_array.push(o)
...
function get_mm_unknown_thing_48(o) {// ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, f32, 8], o)
}
...
function get_mm_unknown_some_values_24_4(o) {// ü(1, [f32, 0, u32, 4, f32, 8], o)
}
...
function get_mm_unknown_some_values_28_4(o) {// ü(1, [f32, 0, u32, 4, f32, 8], o)
}
...
function get_mm_car_model_sec(o) {
    ...
    ä(car_140_16_56, u32(o + 56), get_mm_some_model_link)
...
function get_mm_car_160(o) {
    ...
    ä(car3_44_44, u32(o + 216), get_mm_item_unknown_link)
...
function get_mm_car_section_44_100(o) {
    // ü(1, [u32, 0], o)
    ä(car_172_44_100_0, u32(o + 0), get_car_text_related)

}

function get_car_text_related(o) {
    // if (u32(o + 12))
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
    ö(u32(o + 0), get_car_text_related_0)
    for (let i = 0; i < u32(o + 4); i++) {
        ö(u32(o + 8) + (i * 32), get_car_text_related_8)
    }

}

function get_car_text_related_0(o) {
    console.log(get_string(o, 0, false))
    // ü(1, [f32, 0], o)
}
function get_car_text_related_8(o) {
    if (u32(o + 4) || u32(o + 12))
...
function get_mm_car_204_4(o) {
    ...
    // ä(mm_car_204_4_24, u32(o + ), get_mm_car_204_4_24)

    // ä(mm_car_204_4_28, u32(o + ), get_mm_car_204_4_28)
    ä(texts, u32(o + 100), get_mm_text)
...
function get_mm_car_204_4_16(o) {
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, f32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, u32, 48, u32, 52, u32, 56, u32, 60, ], o)
}
function get_mm_car_204_4_24(o) {
    ü(1, [u32, 0, u32, 4, f32, 8, f32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, u32, 48, f32, 52, f32, 56, f32, 60, ], o)
}
function get_mm_car_204_4_28(o) {
    ü(1, [u32, 0, u32, 4, f32, 8, f32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44, u32, 48, f32, 52, f32, 56, f32, 60, ], o)
}
function get_mm_car_204_4_100(o) {
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
...
function get_mm_car_236_4(o) {
    ...
    // ö(u32(o + 8), get_mm_car_236_4_8)
    switch (u32(o + 4)) {
    case 0:
        ä(mm_unknown, u32(o + 8), get_mm_unknown)
        // ä(mm_car_236_4_8t0, u32(o + ), get_mm_car_236_4_8t0)
        // ö(u32(o + 8), get_mm_car_236_4_8t0)
        break
    case 1:
        ä(mm_strange, u32(o + 8), get_mm_strange)
        // ö(u32(o + 8), get_mm_car_236_4_8t1)
        break
    default:
        if (u32(o + 8)) {
            sü(u32, 4, o, 8)
...
function get_mm_car_236_4_8t0(o) {
    ü(1, [u32, 0, u32, 4, u32, 8, u32, 12, ], o)
}
function get_mm_car_236_4_8t1(o) {
    ü(1, [u32, 0, u32, 4, u32, 8, f32, 12, f32, 16, u32, 20, u32, 24, u32, 28, ], o)
}
...
ü(1, [u8, 0, u8, 1, u8, 2, u8, 3, u32, 4, u32, 8, u32, 12, u32, 16, u32, 20, u32, 24, u32, 28, u32, 32, u32, 36, u32, 40, u32, 44], o)
    ...
    // ö(u32(o + 4), get_mm_car_236_4_12_24_4)
    for (let i = 0; i < u32(o + 8); i++) {
...
function get_mm_car_236_4_12_24_4(o) {
    ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
}
...
function get_mm_car_link_the_third(o) {
    ...
    ä(car3_44, u32(o + 44), get_mm_item_maybe)
...
function get_mm_item_maybe(o) {
    ...
    ä(car3_44_44, u32(o + 44), get_mm_item_unknown_link)
...
function get_mm_item_maybe_60(o) {// ü(1, [f32, 0, u32, 4, u32, 8, u32, 12, u32, 16], o)
}
...
function get_mm_world_52(o) {
    ...
    ä(car3_44_44, u32(o + 64), get_mm_item_unknown_link)
...
function get_mm_world_100(o) {
    ...
    ä(car3_44, u32(o + 40), get_mm_item_maybe)
...
function get_mm_world_140(o) {
    ...
    ä(car3_44, u32(o + 36), get_mm_item_maybe)
}
...
function get_mm_world_164_88(o) {
    // ü(3, [u32, 0, u32, 4, u32, 8, u32, 12], o)
    ü(1, [u32, 0], o)
}
